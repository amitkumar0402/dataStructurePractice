...
public class PermutationsofNumbers {
   ...
   public static void main(String[] args) {
      List<List<Integer>> result = PermutationsofNumbers.findPermutations(new int[] { 1, 3, 5 });
      System.out.print("Here are all the permutations: " + result);

      List<List<Integer>> result1 = PermutationsofNumbers.generatePermutations(new int[] { 1, 3, 5 });
      System.out.print("Here are all the permutations: " + result1);
   }
   }
